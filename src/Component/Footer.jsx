      ...
      <footer class="text-gray-600 body-font">
          ...
          <div class="container px-5 py-8 flex flex-wrap mx-auto items-center">
            <div class="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
              {/* <div class="relative sm:w-64 w-40 sm:mr-4 mr-2">
                <label for="footer-field" class="leading-7 text-sm text-gray-600">Subscribe Newsletter</label>
              ...
              <p class="text-gray-500 text-sm md:ml-6 md:mt-0 mt-2 sm:text-left text-center">Address:
              Near Omaxe City Lucknow - 226025, India
              </p>
            </div>   
            <span class="inline-flex lg:ml-auto lg:mt-0 mt-6 w-full justify-center md:justify-start md:w-auto">
              <a href="https://www.facebook.com/profile.php?id=61564667777330" class="text-gray-500">
            <i class='fa fa-facebook-official'></i>
              </a>
              <a href="https://instagram.com/dsafashionwear" class="ml-3 text-gray-500">
              <i className='fa fa-instagram size-12'></i>
              </a>
              <a href="https://youtube.com/@dsafashionwear?si=8Bbh8aAbrYKnRD9X" class="ml-3 text-gray-500">
        ...
        <div class="bg-gray-100">
          <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p class="text-gray-500 text-sm text-center sm:text-left">© 2024 D'Sa FahionWear & Home Decor

            </p>
            <span class="sm:ml-auto sm:mt-0 mt-2 sm:w-auto w-full sm:text-left text-center text-gray-500 text-sm">  Design & Developed By <a href="https://pixelperfectstrategies.com" class="text-gray-600 ml-1" target="_blank" rel="noopener noreferrer">pixelperfectstrategies</a></span>
          </div>
        </div>
      </footer>
      {/* Footer End */}
